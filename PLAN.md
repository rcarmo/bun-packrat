...
PRD: `docs/PRD.md`  
Status: **Phases 1, 2 and 4 complete — 63 tests passing**
...
| Web UI (search, domain/tag filters, capture form, export links, pagination) | `src/server.ts` | ✅ |
...
| `epubcheck` validation: run manually with `epubcheck <file>.epub` | manual |
| 9-test EPUB suite (structure, mimetype offset, spec compliance) | ✅ |
...
| 4 | Freshness interval before a repeated submission creates a new capture | Not yet implemented; all submissions currently create a new capture |
| 5 | Authenticated captures | Not in scope for Phases 1–2 |
